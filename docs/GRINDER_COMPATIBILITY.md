...
|-------|--------|--------|----------|--------|
| [**Mignon Specialita**](https://www.eureka.co.it/en/products/eureka+1920/mignon+grinders/silent+range/20.aspx) | ✅ **100% Compatible** | Screen replacement | ✅ **Ready** | |
| [**Mignon XL**](https://www.eureka.co.it/en/products/eureka+oro/prosumer+grinders/prosumer/40.aspx) | ✅ **100% Compatible** | Screen replacement | ✅ **Ready** | |
| [**Mignon Turbo**](https://www.eureka.co.it/en/products/eureka+1920/mignon+grinders/turbo+range/75.aspx) | ✅ **100% Compatible** | Screen replacement | ✅ **Ready** | [Discussion #69](https://github.com/jaapp/smart-grind-by-weight/discussions/69) |
| [**Mignon Stark**](https://www.eureka.co.it/en/products/eureka+1920/mignon+grinders/silent+range/82.aspx) | ✅ **100% Compatible** | Screen replacement | ✅ **Ready** | [Discussion #71](https://github.com/jaapp/smart-grind-by-weight/discussions/71) |
| [**Mignon Silenzio**](https://www.eureka.co.it/en/products/eureka+1920/mignon+grinders/silent+range/19.aspx) | 🔧 **Pin soldering** | Custom mount + pins | 🏗️ **WIP design** | No screen |
