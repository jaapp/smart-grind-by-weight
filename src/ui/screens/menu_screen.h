...
public:
    ...
    void create(ConnectivityManager* connectivity, GrindController* grind_ctrl, GrindingScreen* grind_screen, class HardwareManager* hw_mgr, DiagnosticsController* diag_ctrl);
    void show();
    void hide();
